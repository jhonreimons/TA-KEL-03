...
class FileDecryptionApp(QMainWindow):
    def __init__(self):
        ...
        self.settings1 = QSettings('MyCompany', 'MyApp')
        self.last_directory1 = self.settings1.value('last_directory', '.')
    ...
    def choose_file(self):
        ...
        self.file_name, _ = QFileDialog.getOpenFileName(self, "Pilih File untuk Dekripsi", self.last_directory1, f'All Files (*.enc)')
    ...
    def decrypt_file(self):
        ...
        try:
            ...
            output_file_name, _ = QFileDialog.getSaveFileName(self, "Simpan File Hasil Dekripsi", self.last_directory2, f'All Files (*{file_ext})')
            ...
            self.time_label.setText("Waktu dekripsi: " + elapsed_time)
